...
const PagoCreditosCrezcamos = lazy(() =>
  import("./Views/Operaciones/PagoCreditos")
);
  ...
  subRoutes: [
    {
      ...
      label: (
        <AppIcons Logo={"CREZCAMOS_OTRAS_ENTIDADES"} name="Otras entidades" />
      ),
      component: Operacion,
      ...
      subRoutes: [
        {
          ...
          label: (
            <AppIcons
              Logo={"CREZCAMOS_PAGO_CREDITOS"}
              name="Pago Créditos Crezcamos"
            />
          ),
