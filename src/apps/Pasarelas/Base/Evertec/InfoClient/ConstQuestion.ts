...
export const constQuestion: TypingInfoClientConst = {
  ...
  "4|paragraph": `En la tienda virtual de Soluciones en Red SAS usted podrá realizar su pago con los medios habilitados para tal fin. Usted, de acuerdo a las opciones de pago escogidas por el comercio, podrá pagar a través de tarjetas de crédito Visa, American Express, Diners y MasterCard y Cuentas debito ahorro y corriente PSE.
  `,
  //-----------------------
  "5|questions":
  ...
  "10|paragraph": `Si aún no has finalizado tu pago, podrás volver al paso inicial y elegir la forma de pago que prefieras. Una vez finalizada la compra no es posible cambiar la forma de pago.
