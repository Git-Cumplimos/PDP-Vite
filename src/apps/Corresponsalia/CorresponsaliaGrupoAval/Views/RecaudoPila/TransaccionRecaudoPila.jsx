...
const URL_CONSULTAR_COSTO_PLANILLA = `${import.meta.env.VITE_URL_CORRESPONSALIA_AVAL}/recaudo-pila/consulta-planilla`;
const URL_CONSULTAR_COSTO_DOCUMENTO = `${import.meta.env.VITE_URL_CORRESPONSALIA_AVAL}/recaudo-pila/consulta-pin-unico`;
const URL_RECAUDO_PILA = `${import.meta.env.VITE_URL_CORRESPONSALIA_AVAL}/recaudo-pila/recaudo`;
const URL_CONSULTAR_ESTADO_TRX = `${import.meta.env.VITE_URL_CORRESPONSALIA_AVAL}/recaudo-pila/check-bd-estado-trx`;
