...
const DescargarReporteRetiro = () => {
  ...
  return (
    <Fragment>
      <h1 className="text-3xl mt-6">Convenios de Retiros Directo</h1>
      {cargando ? (<>
        <TableEnterprise
      ...
      <Modal show={showModal} handleClose={handleClose}>
        <h2 className="text-3xl mx-auto text-center mb-4">Descargar reporte de retiro</h2>
        <Form onSubmit={DescargarArchivo}>
          {/* <Input
