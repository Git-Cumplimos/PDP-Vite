...
import { ErrorCustomBackend, fetchCustom} from "../utils/fetchCorresponsaliaPowwi"
import { notify, notifyError } from "../../../utils/notify";

const sleep = (millisecons) => {
  return new Promise((resolve) => setTimeout(resolve, millisecons));
};
export const useFetchPowwi = (
  url_trx_ = "",
  url_consulta_ = "",
  name_ = "",
  cod_otp = false
  ...
  const fetchPowwiTrx = useCallback(
