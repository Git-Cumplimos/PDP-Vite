...
import { ErrorCustomBackend, EvaluateResponse, fetchCustom, msgCustomBackend } from "../utils/fetchMoviliza";
import { notify, notifyError } from "../../../utils/notify";
const sleep = (millisecons) => {
    return new Promise((resolve) => setTimeout(resolve, millisecons));
};
export const useFetchMoviliza= (
    url_trx_ = "",
    url_consulta_ = "",
    name_ = "",
) => {
    ...
    const fetchMovilizaTrx = useCallback(
