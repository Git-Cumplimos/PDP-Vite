export const urlConsultarConfiguracionOperadores = `${process.env.REACT_APP_URL_TELEFONIA_MOVIL_BROKER}/backend-telefonia-movil_broker/servicios_configuracion/consultar-configuracion-operadores`;
