...
const FirmaTratamientoDatos = ({
  ...
  const StartSign = (e) => {
    ...
    "imageFormat": 2, "imageX": imgWidth, "imageY": imgHeight, "imageTransparency": false,
