...
// Messages
export const MESSAGE_AUTHORIZER_EMPTY = "No se encontraron autorizaciones.";
...
export const RESPONSE_MESSAGE_EMPTY = "EMPTY";
export const RESPONSE_MESSAGE_ERROR = "ERROR";
export const RESPONSE_MESSAGE_FAILURE = "FAILURE";
export const RESPONSE_MESSAGE_SUCCES = "SUCCESS";
export const RESPONSE_STATUS_SUCCESS = true;
export const RESPONSE_STATUS_ERROR = false;
