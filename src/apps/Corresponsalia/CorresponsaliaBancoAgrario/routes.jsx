...
const RetiroBancoAgrario = lazy(() =>
 import(
   "./Views/Retiro/RetiroBancoAgrario"
 )
);
const RetiroEfectivoBancoAgrario = lazy(() =>
 import(
   "./Views/TrxCuentas/RetiroEfectivo"
 )
);
const DepositoBancoAgrario = lazy(() =>
 import(
   "./Views/TrxCuentas/DepositoEfectivo"
 )
);
const ConveniosRecaudoAgrario = lazy(() =>
 import(
   "./Views/RecaudoServiciosPublicosPrivados/ConveniosRecaudoAgrario"
 )
);
...
const RecaudoServiciosPublicosPrivadosMenuAgrario = lazy(() =>
 import(
   "./Views/RecaudoServiciosPublicosPrivadosMenuAval"
 )
);
...
const rutasAgrarioCB = {
  ...
  subRoutes: [
    ...
    },
    {
      ...
      permission: [enumPermisosAgrario.agrario_cb_recaudo,enumPermisosAgrario.agrario_cb_convenios_recaudo],
      subRoutes: [
        {
