    ...
    (ev) => {
      ...
      notifyPending(
        ...
        },
        {
          render: ({ data: error }) => {
            setLoadingInquiry(false);
            navigate("/Pines/PinesCea", { replace: true });
...
[celular]
  ...
  if (searchingConvData || !(searchingConvData || datosConvenio)) {
    return (
      <Fragment>
        <h1 className='text-3xl mt-6'>Pines CEA</h1>
  ...
  return (
    <Fragment>
      ...
      <h1 className='text-3xl mt-6 mb-10'>Pines CEA</h1>
