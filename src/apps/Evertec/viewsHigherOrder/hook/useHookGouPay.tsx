...
const useHookWithGouPay = (
  ...
  const PeticionCheckUrlProcessBase = useCallback(
    async (
      ...
      const url_check_url_process = `${URL_EVERTEC}/services_evertec/check_pay/check_url_process`;
      let response;
      const body = {
        comercio: {
  ...
  const PeticionConsultForPay = useCallback(
    async (
      ...
      const url_consult_for_pay = `${URL_EVERTEC}/services_evertec/check_pay/check_pay_with_pdp/origin`;
