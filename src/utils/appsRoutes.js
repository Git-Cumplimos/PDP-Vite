 ...
 */
 ...
 const DtlMovCupo = lazy(() =>
   import("../apps/Cupo/Views/DtlMovCupo")
 );
 const CrearCupo = lazy(() =>
   import("../apps/Cupo/Views/CrearCupo")
 );
/**
 * Movii
 */
...
const allUrlsPrivateApps = [
  ...
  {  link: "/cupo",
  label: <AppIcons Logo={"RECAUDO"} name={"cupo"} />,
  component: cupo,
  permission: [1],
  subRoutes: [
    {
      link: "/cupo/detalles-cupo",
      label: <AppIcons Logo={"RECAUDO"} name={"Detalle moviminto cupo"} />,
