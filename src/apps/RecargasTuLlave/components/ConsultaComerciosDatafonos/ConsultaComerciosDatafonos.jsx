...
import { fetchComerciosDatafonos } from "../../utils/fetchTuLlave";

const ConsultaComerciosDatafonos = ({
  handleClose,
  ...
  useEffect(() => {
    fetchComerciosDatafonosFunc();
  }, [page, limit, dataComercios]);
  const fetchComerciosDatafonosFunc = useCallback(() => {
    let obj = {};
    ...
    if (pk_tullave_datafonos)
      obj["pk_tullave_datafonos"] = pk_tullave_datafonos;
    fetchComerciosDatafonos({
      ...obj,
      page,
      limit,
      sortBy: "pk_comercio",
...
export default ConsultaComerciosDatafonos;
