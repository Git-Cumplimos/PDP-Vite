...
import { ErrorCustomBackend, fetchCustom } from "../utils/fetchDale";
import { notify, notifyError } from "../../../../utils/notify";
const sleep = (millisecons) => {
  return new Promise((resolve) => setTimeout(resolve, millisecons));
};
export const useFetchDale = (url_trx_ = "", url_consulta_ = "", name_ = "") => {
  const [state, setState] = useState(false);

  const fetchDaleTrx = useCallback(
