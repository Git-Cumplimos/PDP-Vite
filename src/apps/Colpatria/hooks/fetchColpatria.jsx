...
import { ErrorCustomBackend, fetchCustom } from "../utils/fetchColpatria";
import { notify, notifyError } from "../../../utils/notify";

const sleep = (millisecons) => {
  return new Promise((resolve) => setTimeout(resolve, millisecons));
};
export const useFetchcolpatria = (
  url_trx_ = "",
  url_consulta_ = "",
  name_ = "",
  cod_otp = false
  ...
  const fetchColpatriaTrx = useCallback(
  ...
  return [state, fetchColpatriaTrx];
};
