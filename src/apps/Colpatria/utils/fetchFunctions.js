...
export const getErrorList = buildGetFunction(`${urlColpatriaParams}/error-table`);
export const modErrorList = buildPutFunction(`${urlColpatriaParams}/error-table`);


export const getConveniosPinesList = buildGetFunction(`${urlColpatriaParams}/convenios-pines`);
export const addConveniosPinesList = buildPostFunction(`${urlColpatriaParams}/convenios-pines`);
export const modConveniosPinesList = buildPutFunction(`${urlColpatriaParams}/convenios-pines`);

export const getConveniosPinesTiposValores = buildGetFunction(`${urlColpatriaParams}/tipos-valores-pines`);
export const addConveniosPinesTiposValores = buildPostFunction(`${urlColpatriaParams}/tipos-valores-pines`);
export const modConveniosPinesTiposValores = buildPutFunction(`${urlColpatriaParams}/tipos-valores-pines`);
