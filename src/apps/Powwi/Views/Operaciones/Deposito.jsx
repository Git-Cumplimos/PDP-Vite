...
const URL_CONSULTAR_COSTO = `${import.meta.env.VITE_URL_CORRESPONSALIA_OTROS}/corresponsalia-powwi/consulta-deposito-powwi`;
const URL_DEPOSITO = `${import.meta.env.VITE_URL_CORRESPONSALIA_OTROS}/corresponsalia-powwi/deposito-powwi`;
const URL_CONSULTAR_TRANSACCION_DEPOSITO = `${import.meta.env.VITE_URL_CORRESPONSALIA_OTROS}//corresponsalia-powwi/consulta-estado-deposito-powwi`;
