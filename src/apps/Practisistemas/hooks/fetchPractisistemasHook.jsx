...
import { ErrorCustomBackend, fetchCustom } from "../utils/fetchPractisistemas";
import { notify, notifyError } from "../../../utils/notify";
const sleep = (millisecons) => {
  return new Promise((resolve) => setTimeout(resolve, millisecons));
};
export const useFetchPractisistemas = (
  url_trx_ = "",
  url_consulta_ = "",
  name_ = ""
) => {
  ...
  const fetchPractisistemasTrx = useCallback(
  ...
  return [state, fetchPractisistemasTrx];
};
