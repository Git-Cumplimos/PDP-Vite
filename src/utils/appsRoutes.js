...
import { rutasRecargas, rutasPines, rutasSoat } from "../apps/Practisistemas/routes";
...
const DescargarArchivosS3 = lazy(() => import("../apps/LoteriaBog/Views/DescargarArchivosS3"));
const BorrarBilletes = lazy(() => import("../apps/LoteriaBog/Views/Sorteos/Borrado_billetes"));
const CrearSorteos = lazy(() => import("../apps/LoteriaBog/Views/Sorteos/CrearSorteos"));
const CargaArchivos = lazy(() => import("../apps/LoteriaBog/Views/CargaArchivos"));
const ArqueoBilletes = lazy(() => import("../apps/LoteriaBog/Views/ArqueoBilletes"));
const Premios = lazy(() => import("../apps/LoteriaBog/Views/Premios"));
const Inventario = lazy(() => import("../apps/LoteriaBog/Views/Inventario"));
const ReportInventario = lazy(() => import("../apps/LoteriaBog/Views/ReportesInventario"));

/**
 * ColCard
 */
const ColCard = lazy(() => import("../apps/ColCard/ColCard"));
const RecargarColCard = lazy(() => import("../apps/ColCard/Views/RecargarColCard"));
/**
 * Cupo
 */
const cupo = lazy(() => import("../apps/Cupo/Cupo"));
const DtlMovCupo = lazy(() => import("../apps/Cupo/Views/LimiteCupo/DtlMovComercio"));
...
const TipoMovimientoCupo = lazy(() => import("../apps/Cupo/Views/TipoMovimientoCupo"));
const DetalleLimite = lazy(() => import("../apps/Cupo/Views/DtlMovLimite"));
/**
 * Movii
 */
const MoviiPDP = lazy(() => import("../apps/Movii-pdp/MoviiPDP"));
const MoviiPDPCashOut = lazy(() => import("../apps/Movii-pdp/Views/MoviiPDPCashOut"));
const MoviiPDPReverseCashOut = lazy(() => import("../apps/Movii-pdp/Views/MoviiPDPReverseCashOut"));
/**
 * Marketplace
 */
...
const DesembolsoFDLM = lazy(() => import("../apps/FundacionMujer/Views/Desembolsos"));
...
const TipoContratoComisiones = lazy(() => import("../apps/TrxParams/Views/TipoContratoComisiones"));
const Comisiones = lazy(() => import("../apps/TrxParams/Views/Comisiones"));
const Com2Pay = lazy(() => import("../apps/TrxParams/Views/Comisiones/Com2Pay"));
const CreateComision = lazy(() => import("../apps/TrxParams/Views/Comisiones/CreateComision"));
const Com2Collect = lazy(() => import("../apps/TrxParams/Views/Comisiones/Com2Collect"));
const Convenios = lazy(() => import("../apps/TrxParams/Views/Convenios"));
const ConvAuto = lazy(() => import("../apps/TrxParams/Views/ConvAuto"));
const Autorizadores = lazy(() => import("../apps/TrxParams/Views/Autorizadores"));
const CreateComisionCobrada = lazy(() =>
	import("../apps/TrxParams/Views/Comisiones/CreateComisionCobrada")
);
const ConfiguracionComercios = lazy(() => import("../apps/TrxParams/Views/ConfiguracionComercios"));
const CrearComercios = lazy(() => import("../apps/TrxParams/Views/Comercios/CrearComercios"));
const ListarComercios = lazy(() => import("../apps/TrxParams/Views/Comercios/ListarComercios"));
const TipoNivelComercio = lazy(() => import("../apps/TrxParams/Views/TipoNivelComercios"));
const ListarMensajePublicitario = lazy(() =>
	import("../apps/TrxParams/Views/MensajesPublicitarios/ListarMensajePublicitario")
);
...
const moduloDomiciliacion = lazy(() => import("../apps/Domiciliacion/Views/ModuloDomiciliacion"));
const comprobarEmail = lazy(() => import("../apps/Domiciliacion/Views/BuscarComercioEmail"));
const ModificarPps = lazy(() => import("../apps/Domiciliacion/Views/ModificarPpsVoluntario"));
const BuscarCedulaPpsADemanda = lazy(() =>
	import("../apps/Domiciliacion/Views/BuscarCedulaPpsADemanda")
);

const PpsVoluntarioDemanda = lazy(() => import("../apps/Domiciliacion/Views/PpsVoluntarioDemanda"));
/**
 * Recaudo
 */
 ...
 * Corresponsalia
 */
const Corresponsalia = lazy(() => import("../apps/Corresponsalia/Corresponsalia"));
 ...
 * Modulo Recargas
 */
const RecargasCelular = lazy(() => import("../apps/RecargasCelular/RecargasCelular"));

/**
 * Modulo Movistar
 */
const Movistar = lazy(() => import("../apps/RecargasCelular/Movistar/Movistar.jsx"));
...
const allUrlsPrivateApps = [
		...
		subRoutes: [
			...
			subRoutes: [
				...
				},
				{
					...
					label: <AppIcons Logo={"REPORTE"} name="Reportes Inventario Billetes" />,
	...
	},
	{
		...
		label: <AppIcons Logo={"ACTUALIZACION"} name="Revisar actualizacion de datos" />,
	...
	},
	{
		...
		subRoutes: [
			...
			},
			{
				...
				label: <AppIcons Logo={"RECAUDO"} name={"Modificación límite de cupo"} />,
				...
				subRoutes: [
					{
						...
						label: <AppIcons Logo={"RECARGASMOVISTAR"} name="Recargas Movistar " />,
						component: RecargasMovistar,
						permission: [65],
					},
					{
						link: "/movistar/paquetes-movistar",
						label: <AppIcons Logo={"PAQUETESMOVISTAR"} name="Paquetes Movistar " />,
						...
						subRoutes: [
							...
							},
							{
								...
								label: <AppIcons Logo={"PAQUETESMOVISTAR"} name="Paquete de Voz" />,
								component: SubPaquetesMovistar,
								permission: [65],
							},
							{
								link: "/movistar/paquetes-movistar/paquete-datos",
								label: <AppIcons Logo={"PAQUETESMOVISTAR"} name="Paquete de Datos" />,
								component: SubPaquetesMovistar,
								permission: [65],
							},
							{
						...
						subRoutes: [
							{
								...
								label: <AppIcons Logo={"SORTEO01"} name="Cargue de paquetes de movistar" />,
								...
								subRoutes: [
									{
										...
										label: <AppIcons Logo={"SORTEO01"} name="Decargar archivos" />,
										component: ConcilacionMovistarDescarga,
										permission: [66],
									},
									{
										link: "/movistar/operador-pdp/concilacion/carga",
										label: <AppIcons Logo={"SORTEO01"} name="Cargar archivos" />,
	...
	},
	{
		...
		subRoutes: [
						...
						subRoutes: [
							{
								...
								label: <AppIcons Logo={"IMPUESTO"} name={"Comisiones a pagar por comercio"} />,
						...
						subRoutes: [
							{
								...
								label: <AppIcons Logo={"IMPUESTO"} name={"Comisiones a cobrar por autorizador"} />,
...

			{
				...
				label: <AppIcons Logo={"PRODUCTOS_FINANCIEROS"} name={"Proveedores / Autorizadores"} />,
...

	{
        ...
        permission: [56],
      }, */
			{
				...
				label: <AppIcons Logo={"ACTUALIZACION"} name={"Voluntario a Demanda"} />,
